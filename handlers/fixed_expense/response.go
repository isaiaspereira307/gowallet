...
type CreateFixedExpenseResponse struct {
	Message string          `json:"message"`
	Data    db.FixedExpense `json:"data"`
}

type DeleteFixedExpenseResponse struct {
	Message string          `json:"message"`
	Data    db.FixedExpense `json:"data"`
}

type ShowFixedExpenseResponse struct {
	Message string          `json:"message"`
	Data    db.FixedExpense `json:"data"`
}

type UpdateFixedExpenseResponse struct {
	Message string          `json:"message"`
	Data    db.FixedExpense `json:"data"`
}

type ListFixedExpenseResponse struct {
	Message string            `json:"message"`
	Data    []db.FixedExpense `json:"data"`
}
